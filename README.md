...
| dependencyCheckNvdValidForHours     | Sets the number of hours to wait before checking for new updates from the NVD.                                                                                                                                                                                                                                     | 4                                              |
...
| dependencyCheckKnownExploitedUrl                   | Sets URL to the CISA Known Exploited Vulnerabilities JSON data feed.                                                                                                                                                                                        | https://www.cisa.gov/sites/default/files/feeds/known_exploited_vulnerabilities.json      |
...
| dependencyCheckPoetryAnalyzerEnabled               | Sets whether or not the _experimental_ Poetry Analyzer should be used `dependencyCheckEnableExperimental` must be set to true.                                                                                                                              | true                                                                                     |
...
| dependencyCheckNodeAuditAnalyzerUrl                | Sets the The Node Audit API URL for the Node Audit Analyzer. If not set uses default URL.                                                                                                                                                                   | https://registry.npmjs.org/-/npm/v1/security/audits                                      |
...
| Setting                                        | Description                                                                                                | Default Value                                                                       |
|:-----------------------------------------------|:-----------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------|
| dependencyCheckNvdDatafeedUrl                  | URL for the NVD data feed.                                                                                 | <https://nvd.nist.gov/feeds/json/cve/1.1/nvdcve-1.1-modified.json.gz>               |
| dependencyCheckNvdDatafeedUser                 | The username used when connecting to the `dependencyCheckNvdDatafeedUrl`.                                  |                                                                                     |
| dependencyCheckNvdPassword                     | The password used when connecting to the `dependencyCheckNvdDatafeedUrl`.                                  |                                                                                     |
| dependencyCheckNvdStartYear                    | The first year of NVD CVE data to download from the NVD.                                                   | 2002                                                                                |
