...
trait DependencyCheckKeys {
	...
	lazy val dependencyCheckNvdValidForHours = settingKey[Option[Int]]("Sets the number of hours to wait before checking for new updates from the NVD.")
  ...
  // Analyzer configuration
	...
	lazy val dependencyCheckNvdDatafeedUrl = settingKey[Option[URL]]("URL for the modified NVD data feed.")
	lazy val dependencyCheckNvdDatafeedUser = settingKey[Option[String]]("The username used when connecting to the NVD data feed.")
	lazy val dependencyCheckNvdPassword = settingKey[Option[String]]("The password used when connecting to the NVD data feed.")
	lazy val dependencyCheckNvdStartYear = settingKey[Option[Int]]("The first year of NVD CVE data to download from the NVD.")
